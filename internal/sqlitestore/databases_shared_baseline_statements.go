...
func sharedBaselineStatements() []upstream.Statement {
	return []upstream.Statement{
		...
		{SQL: `INSERT OR IGNORE INTO shared_entity_sequences(entity_type,project_id,project_code,next_number) SELECT 'milestone',project_id,project_code,1 FROM shared_project_identifiers`},
