...
const (
	...
	sharedOutboxProjectMigrationName        = "gpt_tunnel_shared_outbox_project_v16"
)
...
var sharedMigrations = []migrate.Migration{{
	...
	Version: 16,
	Name:    sharedOutboxProjectMigrationName,
	Statements: []store.Statement{
		{SQL: `ALTER TABLE hub_outbox ADD COLUMN project_id TEXT NOT NULL DEFAULT ''`},
	},
}}
