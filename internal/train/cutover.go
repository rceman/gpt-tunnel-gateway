...
var RequiredCutoverActions = []string{
	...
	"train/create", "train/add", "train/read", "train/list", "train/start", "train/advance", "train/correction-start", "train/attempt-finalize", "train/attempt-proof-recover", "train/attempt-review", "train/review-resolve", "train/review-backfill", "train/full-proof", "train/integrate", "train/cutover",
}
