...
var RequiredCutoverActions = []string{
	...
	"train/create", "train/add", "train/read", "train/list", "train/start", "train/advance", "train/attempt-finalize", "train/attempt-proof-recover", "train/attempt-review", "train/full-proof", "train/integrate", "train/cutover",
}
