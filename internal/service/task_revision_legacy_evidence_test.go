...
func legacyTaskRevisionFixture() LegacyTaskRevisionEvidence {
	return LegacyTaskRevisionEvidence{
		SchemaVersion: 1, ID: "EXM-TSK999.REV2", TaskID: "EXM-TSK999", TaskRevision: 2,
		RevisionSHA256: legacyTaskRevisionFixtureHash, ParentTaskRevision: 1,
		ParentTaskSHA256: strings.Repeat("a", 64), ProjectID: "example",
		Title: "Legacy second revision", Objective: "Preserve historical evidence.",
		Branch: "task/example", BaseRevision: "base", AcceptanceCriteria: []string{"one"},
		Constraints: []string{"none"}, RequiredGates: []string{"check"}, WorkflowPolicyRevision: 1,
		OperationClass: "implementation", EffectiveCIField: "task", EffectiveCIMode: "disabled",
		Status: "created", SourceRunID: "EXM-TSK999-RUN1",
		SourceReportID: "EXM-TSK999-RUN1-REPORT", CreatedBy: "planner",
