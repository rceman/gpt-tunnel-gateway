...
func PublicRunView(run model.Run) PublicRun {
	return PublicRun{
		...
		AgentID:             run.AgentID,
		RequestedReasoning:  run.RequestedReasoning,
		ResolvedReasoning:   run.ResolvedReasoning,
		AgentFallback:       run.AgentFallback,
		AgentFallbackReason: run.AgentFallbackReason,
