...
var projectionClasses = map[string]projectionClass{
	...
	"agent/recover": projectionCompactDefault, "agent/register": projectionCompactDefault,
	...
	"git/tree": projectionIntentionalPayload, "git/worktree_diff": projectionIntentionalPayload,
	...
	"project/onboard": projectionCompactDefault, "project/onboard_recover": projectionCompactDefault, "project/read": projectionIntentionalPayload,
	"project/register": projectionCompactDefault, "project/update": projectionCompactDefault,
