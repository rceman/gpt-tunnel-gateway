...
var projectionClasses = map[string]projectionClass{
	...
	"task/read":  projectionClosedDefault, "task/review": projectionClosedDefault, "task/review_decide": projectionClosedDefault, "task/rework": projectionClosedDefault,
	...
	"task/status": projectionClosedDefault, "task/update": projectionClosedDefault, "task/work": projectionCompactDefault,
