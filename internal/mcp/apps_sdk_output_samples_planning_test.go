...
func (f canonicalOutputFixture) canonicalPlanningOutputSamples() map[string]any {
	...
	return map[string]any{
		...
		"task_create": map[string]any{"task": task, "operation": f.operation}, "task_list": map[string]any{"tasks": []service.TaskRecord{{Task: task, State: state, RunSummaries: []model.RunReviewSummary{}}}}, "task_read": f.publicPacket,
