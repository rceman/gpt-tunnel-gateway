...
func taskLifecycleOutputSchema() map[string]any {
	return closedOutput(map[string]any{"task": outputString(), "revision": outputInteger()}, "task", "revision")
}
func taskLifecycleInputProperties() map[string]any {
	return map[string]any{"type": taskTypeSchema(), "scope": map[string]any{"type": "object", "additionalProperties": false, "properties": map[string]any{"files": outputArray(outputString()), "modules": outputArray(outputString())}}, "title": boundedADRString("Task title.", 3, 300), "objective": boundedADRString("Task objective.", 3, 200000), "acceptance_criteria": outputArray(outputString()), "constraints": outputArray(outputString()), "priority": boundedADRString("Task priority.", 0, 32), "dependencies": outputArray(outputString()), "preparation_references": outputArray(outputString()), "metadata": map[string]any{"type": "object", "additionalProperties": outputString()}, "adr_relation": outputString(), "adr_references": outputArray(outputString())}
}
func taskLifecycleCreateSchema() map[string]any {
	return obj(taskLifecycleInputProperties(), "title", "objective", "adr_relation")
}
func taskLifecycleReadSchema() map[string]any {
	return obj(map[string]any{"task": outputString(), "revision": outputInteger()}, "task")
}
...
func taskLifecycleQuerySchema() map[string]any {
	return obj(map[string]any{"cursor": outputString(), "text": outputString(), "status": outputEnum(model.TaskAuthoringPlanned, model.TaskAuthoringReady, model.TaskAuthoringArchived), "type": taskTypeSchema()})
}
func taskLifecycleArchiveSchema() map[string]any {
	return obj(map[string]any{"task": outputString(), "reason": boundedADRString("Archive reason.", 1, 1024)}, "task", "reason")
}
func taskLifecycleHistorySchema() map[string]any {
	return obj(map[string]any{"task": outputString(), "cursor": outputString()}, "task")
}
func taskLifecycleReadOutputSchema() map[string]any {
	p := taskLifecycleInputProperties()
	properties := map[string]any{"task": outputString(), "revision": outputInteger(), "title": p["title"], "status": outputEnum(model.TaskAuthoringPlanned, model.TaskAuthoringReady, model.TaskAuthoringArchived), "type": p["type"], "scope": p["scope"], "objective": p["objective"], "acceptance_criteria": p["acceptance_criteria"], "constraints": p["constraints"], "priority": p["priority"], "dependencies": p["dependencies"], "preparation_references": p["preparation_references"], "metadata": p["metadata"], "adr_relation": p["adr_relation"], "adr_references": p["adr_references"], "created_at": outputDateTime(), "updated_at": outputDateTime(), "revision_reason": outputString()}
	return closedOutput(properties, "task", "revision", "title", "status", "type", "objective", "acceptance_criteria", "constraints", "dependencies", "preparation_references", "adr_relation", "adr_references", "created_at")
}
func taskLifecycleSummarySchema() map[string]any {
	return closedOutput(map[string]any{"task": outputString(), "title": outputString(), "status": outputEnum(model.TaskAuthoringPlanned, model.TaskAuthoringReady, model.TaskAuthoringArchived), "revision": outputInteger(), "updated_at": outputDateTime()}, "task", "title", "status", "revision")
}
func taskLifecycleListOutputSchema() map[string]any {
	return closedOutput(map[string]any{"tasks": outputArray(taskLifecycleSummarySchema())}, "tasks")
}
func taskLifecycleHistoryOutputSchema() map[string]any {
	...
	return closedOutput(map[string]any{"task": outputString(), "revisions": outputArray(row)}, "task", "revisions")
}
