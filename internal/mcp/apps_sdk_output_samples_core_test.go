...
func (f canonicalOutputFixture) canonicalCoreOutputSamples() map[string]any {
	...
	return map[string]any{
		...
		"project_list":         map[string]any{"projects": []model.Project{project}, "next_cursor": "", "has_more": false}, "project_read": project,
