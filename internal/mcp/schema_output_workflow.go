...
func reportOutputSchema() map[string]any {
	...
	serverGate := closedOutput(map[string]any{"id": outputEnum(model.WorkflowGateFormat, model.WorkflowGateCheck, model.WorkflowGateTest), "exit_code": outputInteger()}, "id", "exit_code")
