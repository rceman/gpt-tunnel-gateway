...
func handoffToolOutputSchemas() map[string]map[string]any {
	return map[string]map[string]any{
		...
		"delivery_handoff_list":        closedOutput(map[string]any{"handoffs": outputArray(deliveryHandoffStatusSchema()), "next_cursor": outputString(), "has_more": outputBoolean()}, "handoffs", "next_cursor", "has_more"),
		...
		"planner_report_list":          closedOutput(map[string]any{"reports": outputArray(plannerReportStatusSchema()), "next_cursor": outputString(), "has_more": outputBoolean()}, "reports", "next_cursor", "has_more"),
