...
func TestTSK594GuidesStateCurrentRoleDelegationAndEvidenceAuthority(t *testing.T) {
	...
	for _, concept := range []string{
		...
		"The submitted candidate carries production and tests together",
		"After accepted code, plus any required rebase review, Lead runs controlled asynchronous Task verification",
