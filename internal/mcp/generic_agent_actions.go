...
func agentInterruptOutputSchema() map[string]any {
	return obj(map[string]any{
		...
		"requested": map[string]any{"type": "boolean"}, "elapsed_ms": outputInteger(), "error": outputString(), "reason": outputString(), "started_at": outputDateTime(), "finished_at": outputDateTime(),
