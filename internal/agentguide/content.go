...
func Canonical() Content {
	return Content{
		...
		StatusAwait:      "agent/status and agent/await accept an optional logical Agent selector; when omitted, they use the server-selected managed runtime. Runtime selection is based on stored Agent bindings and role Sessions, not Session-key prefixes.",
