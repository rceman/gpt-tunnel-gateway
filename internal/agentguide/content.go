...
func Canonical() Content {
	return Content{
		...
		Authority:        "Gateway schemas and handlers are the operational contract. No repo guide file, Train record, watcher, or duplicate policy source is authoritative.",
	}
}
