...
func Canonical() Content {
	return Content{
		...
		Exploration:      "Start with targeted repo-local rg and bounded reads. Batch compatible checks, reuse one captured status/branch/HEAD result, and avoid repeated ls, find, status, or log scans. Keep searches inside the assigned repository/worktree.",
