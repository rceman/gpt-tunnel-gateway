...
func TestTrainV2ValidationAndIDAllocation(t *testing.T) {
	...
	train := TrainV2{
		...
		ProjectID:     "gateway",
		Revision:      1,
		Status:        TrainV2Planned,
		CreatedBy:     "planner",
		CreatedAt:     now,
		UpdatedAt:     now,
		Items:         []TrainV2Item{{Position: 0, TaskID: "GTW-TSK179", TaskRevision: 2, TaskRevisionSHA256: "aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa", Status: TrainV2ItemQueued, AddedAt: now}},
	}
