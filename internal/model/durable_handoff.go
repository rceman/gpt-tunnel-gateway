...
func CanonicalDeliveryHandoffDigest(v DeliveryHandoff) (string, error) {
	payload := struct {
		...
		SchemaVersion: v.SchemaVersion, ID: v.ID, ProjectID: v.ProjectID, TaskID: v.TaskID,
		RunID: v.RunID, TaskSHA256: v.TaskSHA256, OwnerSummary: v.OwnerSummary,
		TechnicalEvidence: v.TechnicalEvidence, SupersedesHandoffID: v.SupersedesHandoffID,
		PlanRevision: v.PlanRevision, HubRevision: v.HubRevision, TaskRefs: v.TaskRefs,
		TrainRefs: v.TrainRefs, PlanSectionRefs: v.PlanSectionRefs, OperatorEventRefs: v.OperatorEventRefs,
		ExpectedRepoBase: v.ExpectedRepoBase, ExpectedRepoHead: v.ExpectedRepoHead,
		FirstAction: v.FirstAction, StopBoundary: v.StopBoundary,
		ProhibitedOperations: v.ProhibitedOperations, InstructionBody: v.InstructionBody,
		RoleRefs: v.RoleRefs, DelegationRefs: v.DelegationRefs, AuthorRole: v.AuthorRole, ConsumerRole: v.ConsumerRole, CreatedBy: v.CreatedBy,
